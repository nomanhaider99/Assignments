...
let personName_1: string = "/t/n John Doe/y/n"
let orgStr: string = personName_1
let newStr1: string = personName_1.slice(5, 9)
let newStr2: string = personName_1.slice(10, 13)
console.log(orgStr)
...
const persons: string[] = ["Noman", "Haris"]
function printMessage(persons: string){
...
function printMessage1(persons: string){
    console.log(`${persons} is a boy.`);
}
...
guests1.pop();
guests1.push("Shera")
let addedGuest30: any = guests1.forEach((person: string) => {
    console.log(`${person}`)
})
...
guests2.push("Haris");
let middle_index: number = Math.floor(guests.length/2);
...
guests3.push("Haris");
let middle_index2: number = Math.floor(guests.length/2);
guests.splice(middle_index2, 0, "Anwer");
console.log("I can invite only two people for dinner.")
let last_guest: string | undefined = guests3.pop();
let secondlast_guest: string | undefined = guests3.pop();
let thirdlast_guest: string | undefined = guests3.pop();
let fourthlast_guest: string | undefined = guests3.pop();
...
let places: string[] = ["Karachi", "Swat", "Multan", "Dadu", "Balakot"];
...
guests5.pop();
guests5.push("Shera")
let addedGuest: any = guests.forEach((person: string) => {
    console.log(`${person}`)
})
...
guests5.push("Haris");
let middle_index5: number = Math.floor(guests.length/2);
...
console.log("I can invite only two people for dinner.")
let last_guest5: string | undefined = guests5.pop();
let secondlast_guest5: string | undefined = guests5.pop();
let thirdlast_guest5: string | undefined = guests5.pop();
let fourthlast_guest5: string | undefined = guests5.pop();
...
let things: string[] = ["mountains", "rivers", "cities"];
const listed = things.forEach((items: string): any =>{
})
for(let i: number = 1; i<=things.length; i++){
...
let myArray: (number | string | boolean)[] = [100, true, "Noman"];
...
let alien_color51: string = "green";
if(alien_color51 == "green"){
    console.log("player earned 5 points.")
}
let alien_color52: string = "yellow";
...
let Fav_fruits: string[] = ["apple", "orange", "grapes", "mango"];
...
let usernames: string[] = ["admin", "noman", "haris", "anwer", "hassan"];
const login = (ans: number)=>{
...
let current_users: string[] = ["noman", "haris", "anwer", "hassan", "ahmed"];
let new_users: string[] = ["Noman", "Haris", "arsalan", "zahoor", "malhar"];
let lower_current_user: string[] = current_users.map((user: string): string=> user.toLowerCase());
let lower_new_user: string[] = new_users.map((user: string): string=> user.toLowerCase());
lower_new_user.forEach((user: string): void =>{
...
let slicedArray1: number[] = MyArray.slice(0, 3);
let slicedArray2: number[] = MyArray.slice(0, 8);
console.log(`${slicedArray1[0]}st`)
console.log(`${slicedArray1[1]}nd`)
console.log(`${slicedArray1[2]}rd`)
for(let i: number = 3; i <= slicedArray2.length; i++){
...
let pizza : Array<string> = ["tikka", "fajita", "pepporoni"];
for(let i: number = 0; i < pizza.length; i++) {
    console.log(`I like ${pizza[i]} pizza.`);
}
pizza.forEach((flavour: string): void=>{
...
const make_shirt: (size: string, message: string) => string = (size: string, message: string) => {
...
const make_shirt0= (size: string = "large", mesg: string = "I love TS") =>{
    console.log(`write a ${mesg} on the ${size} size shirt.`)
}
make_shirt0()
const make_shirt1= (size: string, mesg: string = "I love TS") =>{
    console.log(`write a ${mesg} on the ${size} size shirt.`)
}
make_shirt1("large")
make_shirt1("medium")
const make_shirt2= (mesg: string, size: string = "any") =>{
    console.log(`write a ${mesg} on the ${size} size shirt.`)
}
...
const make_album = (artist_name: string, album_title: string, number_of_tracks?: number): Album =>{
    const Obj: Album = {
        artist_name,
        album_title,
    }
...
const show_magicians = (magicians: Array<string>) =>{
...
let magicians0: string[] = [];
const show_magicians0 = (magicians: Array<string>) =>{
    magicians0.forEach((names)=>{
            console.log(`-${names}`);
        })
        const make_great0 = (magicians: string[]) =>{
            magicians.forEach((name: string) =>{
...
const add_topping = (items: string[]): string => {
...
const car_info = (manufacturer: string, model: string, Hybrid?: boolean, Seddan?: boolean): object => {
    const Car: Info = {
        manufacturer,
        model,
    }
